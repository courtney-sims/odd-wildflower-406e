...
```
npm create cloudflare@latest -- --template=cloudflare/templates/odd-wildflower-406e
```

A live public deployment of this template is available at [https://odd-wildflower-406e.templates.workers.dev](https://odd-wildflower-406e.templates.workers.dev)
